...
static void set_color_for_state(cairo_t *cairo, struct swaylogout_state *state,
		struct swaylogout_colorset *colorset) {
...
static void timetext(struct swaylogout_surface *surface, char **tstr, char **dstr) {
...
void render_frame(struct swaylogout_surface *surface) {
	...
	// but it works slightly differently from swaylogout-effects' --indicator
	// option. To maintain compatibility with upstream swaylogout scripts as well
	// as with old swaylogout-effects scripts, I will keep both flags.
