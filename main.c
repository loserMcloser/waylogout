...
int main(int argc, char **argv) {
    ...
    .icon_lock = "",
    .icon_switch = "",
    .shortcut_poweroff = XKB_KEY_p,
    .shortcut_reboot = XKB_KEY_r,
    .shortcut_suspend = XKB_KEY_s,
    .shortcut_hibernate = XKB_KEY_h,
    .shortcut_logout = XKB_KEY_x,
    .shortcut_reload = XKB_KEY_c,
    .shortcut_lock = XKB_KEY_k,
    .shortcut_switch = XKB_KEY_w,
		.hide_cancel = false,
