...
struct waylogout_args {
	...
	char *command_reboot;
  char *command_suspend;
	char *command_hibernate;
	char *command_logout;
	char *command_reload;
	char *command_lock;
  char *command_switch;
  ...
  char *icon_suspend;
	...
	char *icon_lock;
  char *icon_switch;
	xkb_keysym_t shortcut_poweroff;
	xkb_keysym_t shortcut_reboot;
  xkb_keysym_t shortcut_suspend;
	xkb_keysym_t shortcut_hibernate;
	xkb_keysym_t shortcut_logout;
	xkb_keysym_t shortcut_reload;
	xkb_keysym_t shortcut_lock;
  xkb_keysym_t shortcut_switch;
	bool hide_cancel;
	bool reverse_arrows;
	bool screenshots;
